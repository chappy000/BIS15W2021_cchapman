...
Helpful for your readers to have consistent themes/visuals so they don't have to learn how to read each new graph
```{r}
p <- homerange %>% 
...
Using shape AND color is useful in showing trends
```{r}
...
Don't have to fill with a new variable...
```{r}
homerange %>% 
...
"color" just gives outline of colors
```{r}
homerange %>% 
