...
Change directory thru sessions or "setwd()"
...
##   .. )
```
Or use glimpse to get a summary
"dbl" means numeric data
...
A factor shows the name as as a whole word, rather than a string of characters . . . "17" vs. "1" and "7"
...
## Columns: 4
## $ temp_c    <dbl> 36.25, 35.40, 35.30, 35.15, 35.35, 33.35, 30.70, 29.65, 2...
## $ scientist <fct> Jill, Susan, Steve, Jill, Susan, Steve, Jill, Susan, Steve
## $ spring    <chr> "Buckeye", "Buckeye", "Buckeye", "Benton", "Benton", "Ben...
## $ depth_ft  <dbl> 4.15, 4.13, 4.12, 3.21, 3.23, 3.20, 5.67, 5.65, 5.66
```
...
Fish was not in the lab 3 wd, can tell it go to the data folder within the lab 3 folder with (data/"name")
...
```r
#because I moved the file to the lab3 folder
...
```r
#works best for things that are categorical (otherwise, each value is it's own category)
```
