...
We need to replace the -999 with NAs
```{r}
...
If you use this, you must be sure you know what you want replaced because you are changing them at the very beginning
```{r}
