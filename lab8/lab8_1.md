...
The income variable is split up into many columns and the observations for each religion all share a row instead of getting their own row
...
The variable data is distributed along multiple columns and the respective observations for those variables share a row
